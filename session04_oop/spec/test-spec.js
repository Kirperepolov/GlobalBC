describe('OOP in JavaScript', function() {
  ...
  describe('Test Hero creation', function() {
    ...
    it('It should be possible to create a Hero instance', function() {
        expect(warrior instanceof Hero ).toBe(true);
        expect(rogue instanceof Hero ).toBe(true);
        expect(sorcerer instanceof Hero ).toBe(true);
      });
  ...
  describe('Test Game Creation', function() {
    ...
    it('Game default initiaing parameters shoud be correct', function() {
